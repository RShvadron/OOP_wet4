...
public class Billboard extends JFrame implements ActionListener {
    ...
    //    Represents a Billboard that is consisted of 25 Panels witch are viewed as a matrix of 5x5. panels are fixed size squares stored at this.panels
	...
	//	 1) All graphic elements shouldn't be null.
	//	 2) Panels list must contain 25 panels and shouldn't be null.
	//	 3) ColorGenerator shouldn't be null. 
	...
	private JMenuBar createMenuBar() {
	    ...
	    columnItem = new JRadioButtonMenuItem("Left to Right Column");
	...
	/**
	 * @modifies g
	 * @effects Paints all the panels of this to g. This method is invoked
